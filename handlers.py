...
async def check_group_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if has_custom_ad_link(text, custom_links):
        try:
            ...
            print("CUSTOM AD LINK VIOLATION ERROR:", e)
    ...
    if has_ad_phrase(text, ad_phrases):
        try:
            ...
            print("AD PHRASE VIOLATION ERROR:", e)
...
async def private_text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.get("state") == "auto_reply_button":
        ...
        if not button_text or not button_url.startswith(("http://", "https://", "tg://")):
            await message.reply_text(TEXTS[lang]["auto_reply_button_invalid"])
            return
