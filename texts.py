TEXTS = {
    "ru": {
        ...
        "plan_notify_3d": (
            ...
            "У группы <b>{title}</b> срок тарифа заканчивается через 3 дня.\n\n"
            "Дата окончания:\n"
            "{expires_at}\n\n"
            "Чтобы управление группой не остановилось, продлите тариф заранее."
        ),
        "plan_notify_1d": (
            "⚠️ <b>Тариф скоро закончится</b>\n\n"
            "У группы <b>{title}</b> срок тарифа заканчивается через 1 день.\n\n"
            "Дата окончания:\n"
            "{expires_at}\n\n"
            "После окончания тарифа бот перестанет управлять группой."
        ),
        "plan_notify_expired": (
            "🚫 <b>Тариф закончился</b>\n\n"
            "У группы <b>{title}</b> срок тарифа истёк.\n\n"
            "Дата окончания:\n"
            "{expires_at}\n\n"
            "Группа деактивирована. Для возобновления работы необходимо продлить тариф."
        ),
